package com.example.curator.ui.screens.single_chat
...
import com.example.curator.database.*
import com.example.curator.models.CommonModel
import com.example.curator.models.UserModel
import com.example.curator.ui.message_recycler_view.views.AppViewFactory
...
class SingleChatFragment(private val contact: CommonModel) : BaseFragment(R.layout.fragment_single_chat) {
    ...
    private fun initRecycleView() {
        ...
        mRefMessages = REF_DATABASE_ROOT
            .child(NODE_MESSAGES).child(CURRENT_UID).child(contact.id)
